...
void DMARender::RenderWindow::drawMapHandler() {
    ...
    // Falls Follow Player aktiviert ist, passe mTrans basierend auf der Fenstergr鲞e an
    if (followPlayerEnabled) {
        ...
        //std::cout << "Gew黱schter Offset: (" << desiredOffsetX << ", " << desiredOffsetY << ")\n";
        //std::cout << "Aktueller Offset: (" << mTrans.dragOffsetX << ", " << mTrans.dragOffsetY << ")\n";

        // Schwellwert: nur anpassen, wenn der Unterschied gr鲞er als z. B. 5 Pixel ist
